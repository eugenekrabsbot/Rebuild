    ...
    <>
      ...
      <footer style={styles.footer}>
        <div style={styles.footerSocial}>
          <a href="https://x.com/AhoyVPN" target="_blank" rel="noopener noreferrer" style={styles.socialLink} aria-label="Follow AhoyVPN on X">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
            X / Twitter
          </a>
          <a href="https://www.instagram.com/ahoy_vpn/" target="_blank" rel="noopener noreferrer" style={styles.socialLink} aria-label="Follow AhoyVPN on Instagram">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
          ...
          <a href="https://www.facebook.com/AhoyVPN" target="_blank" rel="noopener noreferrer" style={styles.socialLink} aria-label="Follow AhoyVPN on Facebook">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
